...
SOL_OUTPUT_SCHEMA = {
    ...
    "verdict": "pass | pass_with_minors | revise",
    ...
    "scores": {"dimension_name": "INTEGER on a 0-100 scale, always"},
...
def annotations_get(target_type: str, target_id: str) -> dict:
    ...
    with _db() as conn:
        ...
        finds = _rows(conn.execute(
            ...
            "r.completed_by, r.model FROM findings f "
        ...
        for r in conn.execute(
                ...
                "a.completed_by, a.model FROM strengths s "
